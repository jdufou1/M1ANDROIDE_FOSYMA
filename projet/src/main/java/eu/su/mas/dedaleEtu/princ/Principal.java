...
//		agentList.add(ag);	
		...
		ag=createNewDedaleAgent(c, agentName, AgentProjet.class.getName(), entityParametersExplo1);//ExploreSoloAgent
		agentList.add(ag);
		...
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentProjet.class.getName(), entityParametersExplo2);//ExploreSoloAgent
		agentList.add(ag);	
		...
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, AgentProjet.class.getName(), entityParametersExplo3);//ExploreSoloAgent
